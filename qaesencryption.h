...
namespace Sekura {
    ...
    class QAESEncryption : public QObject {
      ...
      public:
        ...
        static QByteArray DefCrypt(const QByteArray &rawText, const QByteArray &key,
                                   const QByteArray &iv = NULL);
        static QByteArray DefDecrypt(const QByteArray &rawText, const QByteArray &key,
                                     const QByteArray &iv = NULL);
        ...
        static QByteArray Decrypt(QAESEncryption::Aes level, QAESEncryption::Mode mode,
                                  ...
                                  const QByteArray &iv = NULL,
                                  QAESEncryption::Padding padding = QAESEncryption::ISO);
        static QByteArray ExpandKey(QAESEncryption::Aes level, QAESEncryption::Mode mode,
